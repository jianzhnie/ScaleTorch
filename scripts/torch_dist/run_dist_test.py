...
def test_scatter() -> None:
    ...
    print(f'Rank {dist.get_rank()}: scatter test passed')
...
def test_reduce() -> None:
    ...
    print(f'Rank {dist.get_rank()}: reduce sum test passed')
    ...
    print(f'Rank {dist.get_rank()}: reduce max test passed')
...
def test_reduce_scatter() -> None:
    ...
    print(f'Rank {dist.get_rank()}: reduce_scatter test passed')
...
def test_all_to_all() -> None:
    ...
    print(f'Rank {dist.get_rank()}: all_to_all test passed')
...
def test_all_reduce() -> None:
    ...
    print(f'Rank {dist.get_rank()}: all_reduce sum test passed')
    ...
    print(f'Rank {dist.get_rank()}: all_reduce max test passed')
...
def test_all_gather() -> None:
    ...
    print(f'Rank {dist.get_rank()}: all_gather test passed')
...
def test_gather() -> None:
    ...
    if dist.get_rank() == 0:
        ...
        print(f'Rank {dist.get_rank()}: gather test passed')
    else:
        assert gathered_data == [], f'Expected empty list, got {gathered_data}'
        print(f'Rank {dist.get_rank()}: gather test passed (empty list)')
...
def test_broadcast() -> None:
    ...
    print(f'Rank {dist.get_rank()}: broadcast test passed')
...
def test_sync_random_seed() -> None:
    ...
    """
    print('Testing sync_random_seed...')
...
def test_broadcast_object_list() -> None:
    ...
    """
    print('Testing broadcast_object_list...')
    # 只有rank 0有有效数据
    data: List[Any] = []
    if dist.get_rank() == 0:
    ...
    print(f'Rank {dist.get_rank()}: broadcast_object_list test passed')
...
def test_all_reduce_dict() -> None:
    ...
    print(f'Rank {dist.get_rank()}: all_reduce_dict test passed')
...
def test_all_gather_object() -> None:
    ...
    and made available on all processes.
    """
    print('Testing all_gather_object...')
    world_size = dist.get_world_size()
    ...
    print(f'Rank {dist.get_rank()}: all_gather_object test passed')
...
def test_gather_object() -> None:
    ...
    if dist.get_rank() == 0:
        ...
        print(f'Rank {dist.get_rank()}: gather_object test passed')
    else:
        assert gathered_data is None, f'Expected None, got {gathered_data}'
        print(f'Rank {dist.get_rank()}: gather_object test passed (None)')
...
def test_all_reduce_params() -> None:
    ...
    """
    print('Testing all_reduce_params...')
    world_size = dist.get_world_size()
    ...
    print(f'Rank {dist.get_rank()}: all_reduce_params test passed')
...
if __name__ == '__main__':
    ...
    print(f'Running tests on Rank {rank}/{world_size-1}')
